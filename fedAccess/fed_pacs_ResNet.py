...
if __name__ == '__main__':
    ...
    if log:
        log_path = os.path.join('../logs', exp_folder)
    ...
    # setup model
    server_model = torchvision.models.resnet50()
    server_model.fc = nn.Linear(server_model.fc.in_features, 7)
